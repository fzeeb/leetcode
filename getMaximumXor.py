...
class Solution:
    def getMaximumXor(self, nums: List[int], maximumBit: int) -> List[int]:
        ...
        result = []
        # Append the result of xor XOR max_xor to the result list
...
# Test Cases
s = Solution()
print(s.getMaximumXor([0,1,1,3], 2) == [0,3,2,3])
print(s.getMaximumXor([2,3,4,7], 3) == [5,2,6,5])
print(s.getMaximumXor([0,1,2,2,5,7], 3) == [4,3,6,4,6,7])