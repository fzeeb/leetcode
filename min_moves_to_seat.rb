...
You may perform the following move any number of times:
    Increase or decrease the position of the ith student by 1 (i.e., moving the i^th student from position x to x + 1 or x - 1)
...
print min_moves_to_seat([3, 1, 5], [2, 7, 4]) # 4
print min_moves_to_seat([4, 1, 5, 9], [1, 3, 2, 6]) # 7
print min_moves_to_seat([2, 2, 6, 6], [1, 3, 2, 6]) # 4